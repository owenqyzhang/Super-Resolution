...
# System parameters
Flags.DEFINE_string('output_dir', './experiment_ensemble_VGG54/', 'The output directory of the checkpoint.')
Flags.DEFINE_string('summary_dir', './experiment_ensemble_VGG54/log/', 'The directory to store the summaries.')
Flags.DEFINE_string('mode', 'train', 'Mode for running: train, test, or inference.')
Flags.DEFINE_string('checkpoint_SRResNet', './experiment_SRResnet/model-20000', 'If provided, the weights will be'
                                                                                'restored from the provided checkpoint.')
Flags.DEFINE_string('checkpoint_EDSR', './experiment_EDSR/model-460000', 'If provided, the weights will be restored'
...
Flags.DEFINE_string('task', 'ensemble', 'SRResNet, EDSR, ensemble, SRGAN or EDSRGAN')
