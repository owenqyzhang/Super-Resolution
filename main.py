...
# System parameters
Flags.DEFINE_string('output_dir', './experiment_SRResnet/', 'The output directory of the checkpoint.')
Flags.DEFINE_string('summary_dir', './experiment_SRResnet/log/', 'The directory to store the summaries.')
...
Flags.DEFINE_string('task', 'SRResNet', 'SRResNet, EDSR, ensemble, SRGAN or EDSRGAN')
